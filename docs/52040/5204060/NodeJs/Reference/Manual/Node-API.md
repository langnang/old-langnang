...
-   `[in] handle`: The handle that must be passed to [`napi_remove_async_cleanup_hook`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_remove_async_cleanup_hook) after completion of the asynchronous cleanup.
...
[`napi_get_last_error_info`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_get_last_error_info) returns the information for the last N-API call that was made.
...
##### napi\_fatal\_exception[#](http://nodejs.cn/api-v12/n-api.html#napi_fatal_exception)
...
#### 使句柄的生命期限短于原生方法[#](http://nodejs.cn/api-v12/n-api.html#making-handle-lifespan-shorter-than-that-of-the-native-method)
...
##### napi\_add\_async\_cleanup\_hook[#](http://nodejs.cn/api-v12/n-api.html#napi_add_async_cleanup_hook)
...
#### 枚举类型[#](http://nodejs.cn/api-v12/n-api.html#enum-types)
...
JavaScript `ArrayBuffer` objects are described in [Section 24.1](http://url.nodejs.cn/yZdrF9) of the ECMAScript Language Specification.
...
##### napi\_get\_value\_int32[#](http://nodejs.cn/api-v12/n-api.html#napi_get_value_int32)
...
##### napi\_get\_value\_int64[#](http://nodejs.cn/api-v12/n-api.html#napi_get_value_int64)
...
`Number` values outside the range of [`Number.MIN_SAFE_INTEGER`](http://url.nodejs.cn/VVdtdf) `-(2**53 - 1)` - [`Number.MAX_SAFE_INTEGER`](http://url.nodejs.cn/Jknba7) `(2**53 - 1)` will lose precision.

Non-finite number values (`NaN`, `+Infinity`, or `-Infinity`) set the result to zero.

##### napi\_get\_value\_string\_latin1[#](http://nodejs.cn/api-v12/n-api.html#napi_get_value_string_latin1)
...
##### napi\_get\_value\_string\_utf8[#](http://nodejs.cn/api-v12/n-api.html#napi_get_value_string_utf8)
...
##### napi\_get\_value\_string\_utf16[#](http://nodejs.cn/api-v12/n-api.html#napi_get_value_string_utf16)
...
##### napi\_get\_value\_uint32[#](http://nodejs.cn/api-v12/n-api.html#napi_get_value_uint32)
...
#### 获取全局实例的函数[#](http://nodejs.cn/api-v12/n-api.html#functions-to-get-global-instances)

##### napi\_get\_boolean[#](http://nodejs.cn/api-v12/n-api.html#napi_get_boolean)
...
##### napi\_get\_global[#](http://nodejs.cn/api-v12/n-api.html#napi_get_global)
...
##### napi\_get\_null[#](http://nodejs.cn/api-v12/n-api.html#napi_get_null)
...
##### napi\_get\_undefined[#](http://nodejs.cn/api-v12/n-api.html#napi_get_undefined)
...
### 使用 JavaScript 值和抽象操作[#](http://nodejs.cn/api-v12/n-api.html#working-with-javascript-values-and-abstract-operations)

N-API exposes a set of APIs to perform some abstract operations on JavaScript values. Some of these operations are documented under [Section 7](http://url.nodejs.cn/rqSJ9h) of the [ECMAScript Language Specification](http://url.nodejs.cn/7fw6aN).
...
#### napi\_coerce\_to\_bool[#](http://nodejs.cn/api-v12/n-api.html#napi_coerce_to_bool)
...
This API implements the abstract operation `ToBoolean()` as defined in [Section 7.1.2](http://url.nodejs.cn/WAPnXf) of the ECMAScript Language Specification. This API can be re-entrant if getters are defined on the passed-in `Object`.

#### napi\_coerce\_to\_number[#](http://nodejs.cn/api-v12/n-api.html#napi_coerce_to_number)
...
This API implements the abstract operation `ToNumber()` as defined in [Section 7.1.3](http://url.nodejs.cn/mDmGFA) of the ECMAScript Language Specification. This API can be re-entrant if getters are defined on the passed-in `Object`.

#### napi\_coerce\_to\_object[#](http://nodejs.cn/api-v12/n-api.html#napi_coerce_to_object)
...
This API implements the abstract operation `ToObject()` as defined in [Section 7.1.13](http://url.nodejs.cn/s8CpUJ) of the ECMAScript Language Specification. This API can be re-entrant if getters are defined on the passed-in `Object`.

#### napi\_coerce\_to\_string[#](http://nodejs.cn/api-v12/n-api.html#napi_coerce_to_string)
...
This API implements the abstract operation `ToString()` as defined in [Section 7.1.13](http://url.nodejs.cn/s8CpUJ) of the ECMAScript Language Specification. This API can be re-entrant if getters are defined on the passed-in `Object`.

#### napi\_typeof[#](http://nodejs.cn/api-v12/n-api.html#napi_typeof)
...
This API represents behavior similar to invoking the `typeof` Operator on the object as defined in [Section 12.5.5](http://url.nodejs.cn/UURRdy) of the ECMAScript Language Specification. However, there are some differences:
...
#### napi\_instanceof[#](http://nodejs.cn/api-v12/n-api.html#napi_instanceof)
...
This API represents invoking the `instanceof` Operator on the object as defined in [Section 12.10.4](http://url.nodejs.cn/EWyidy) of the ECMAScript Language Specification.

#### napi\_is\_array[#](http://nodejs.cn/api-v12/n-api.html#napi_is_array)
...
This API represents invoking the `IsArray` operation on the object as defined in [Section 7.2.2](http://url.nodejs.cn/hQESef) of the ECMAScript Language Specification.

#### napi\_is\_arraybuffer[#](http://nodejs.cn/api-v12/n-api.html#napi_is_arraybuffer)
...
#### napi\_is\_buffer[#](http://nodejs.cn/api-v12/n-api.html#napi_is_buffer)
...
#### napi\_is\_date[#](http://nodejs.cn/api-v12/n-api.html#napi_is_date)
...
#### napi\_is\_error[#](http://nodejs.cn/api-v12/n-api.html#napi_is_error_1)
...
#### napi\_is\_typedarray[#](http://nodejs.cn/api-v12/n-api.html#napi_is_typedarray)
...
#### napi\_is\_dataview[#](http://nodejs.cn/api-v12/n-api.html#napi_is_dataview)
...
#### napi\_strict\_equals[#](http://nodejs.cn/api-v12/n-api.html#napi_strict_equals)
...
This API represents the invocation of the Strict Equality algorithm as defined in [Section 7.2.14](http://url.nodejs.cn/jFa5Tv) of the ECMAScript Language Specification.

#### napi\_detach\_arraybuffer[#](http://nodejs.cn/api-v12/n-api.html#napi_detach_arraybuffer)

新增于: v12.16.0 N-API version: 7
...
Generally, an `ArrayBuffer` is non-detachable if it has been detached before. The engine may impose additional conditions on whether an `ArrayBuffer` is detachable. For example, V8 requires that the `ArrayBuffer` be external, that is, created with [`napi_create_external_arraybuffer`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_create_external_arraybuffer).

This API represents the invocation of the `ArrayBuffer` detach operation as defined in [Section 24.1.1.3](http://url.nodejs.cn/XGBZGf) of the ECMAScript Language Specification.

#### napi\_is\_detached\_arraybuffer[#](http://nodejs.cn/api-v12/n-api.html#napi_is_detached_arraybuffer)
...
This API represents the invocation of the `ArrayBuffer` `IsDetachedBuffer` operation as defined in [Section 24.1.1.2](http://url.nodejs.cn/8JSbbt) of the ECMAScript Language Specification.

### 处理 JavaScript 属性[#](http://nodejs.cn/api-v12/n-api.html#working-with-javascript-properties)

N-API exposes a set of APIs to get and set properties on JavaScript objects. Some of these types are documented under [Section 7](http://url.nodejs.cn/rqSJ9h) of the [ECMAScript Language Specification](http://url.nodejs.cn/7fw6aN).
...
#### 构造[#](http://nodejs.cn/api-v12/n-api.html#structures)

##### napi\_property\_attributes[#](http://nodejs.cn/api-v12/n-api.html#napi_property_attributes)
...
`napi_property_attributes` are flags used to control the behavior of properties set on a JavaScript object. Other than `napi_static` they correspond to the attributes listed in [Section 6.1.7.1](http://url.nodejs.cn/a21J82) of the [ECMAScript Language Specification](http://url.nodejs.cn/7fw6aN). They can be one or more of the following bitflags:
...
-   `napi_configurable`: The property is configurable as defined in [Section 6.1.7.1](http://url.nodejs.cn/a21J82) of the [ECMAScript Language Specification](http://url.nodejs.cn/7fw6aN).
-   `napi_static`: The property will be defined as a static property on a class as opposed to an instance property, which is the default. This is used only by [`napi_define_class`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_define_class). It is ignored by `napi_define_properties`.
...
##### napi\_property\_descriptor[#](http://nodejs.cn/api-v12/n-api.html#napi_property_descriptor)
...
-   `getter`: A function to call when a get access of the property is performed. If this is passed in, set `value` and `method` to `NULL` (since these members won't be used). The given function is called implicitly by the runtime when the property is accessed from JavaScript code (or if a get on the property is performed using a N-API call). [`napi_callback`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_callback) provides more details.
-   `setter`: A function to call when a set access of the property is performed. If this is passed in, set `value` and `method` to `NULL` (since these members won't be used). The given function is called implicitly by the runtime when the property is set from JavaScript code (or if a set on the property is performed using a N-API call). [`napi_callback`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_callback) provides more details.
-   `method`: Set this to make the property descriptor object's `value` property to be a JavaScript function represented by `method`. If this is passed in, set `value`, `getter` and `setter` to `NULL` (since these members won't be used). [`napi_callback`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_callback) provides more details.
-   `attributes`: The attributes associated with the particular property. See [`napi_property_attributes`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_property_attributes).
-   `data`: The callback data passed into `method`, `getter` and `setter` if this function is invoked.

#### 函数[#](http://nodejs.cn/api-v12/n-api.html#functions)

##### napi\_get\_property\_names[#](http://nodejs.cn/api-v12/n-api.html#napi_get_property_names)
...
-   `[out] result`: A `napi_value` representing an array of JavaScript values that represent the property names of the object. The API can be used to iterate over `result` using [`napi_get_array_length`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_get_array_length) and [`napi_get_element`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_get_element).
...
##### napi\_get\_all\_property\_names[#](http://nodejs.cn/api-v12/n-api.html#napi_get_all_property_names)
...
-   `[out] result`: A `napi_value` representing an array of JavaScript values that represent the property names of the object. [`napi_get_array_length`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_get_array_length) and [`napi_get_element`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_get_element) can be used to iterate over `result`.

Returns `napi_ok` if the API succeeded.

This API returns an array containing the names of the available properties of this object.

##### napi\_set\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_set_property)
...
##### napi\_get\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_get_property)
...
##### napi\_has\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_has_property)
...
##### napi\_delete\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_delete_property)
...
##### napi\_has\_own\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_has_own_property)
...
##### napi\_set\_named\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_set_named_property)
...
This method is equivalent to calling [`napi_set_property`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_set_property) with a `napi_value` created from the string passed in as `utf8Name`.

##### napi\_get\_named\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_get_named_property)
...
This method is equivalent to calling [`napi_get_property`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_get_property) with a `napi_value` created from the string passed in as `utf8Name`.

##### napi\_has\_named\_property[#](http://nodejs.cn/api-v12/n-api.html#napi_has_named_property)
...
This method is equivalent to calling [`napi_has_property`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_has_property) with a `napi_value` created from the string passed in as `utf8Name`.

##### napi\_set\_element[#](http://nodejs.cn/api-v12/n-api.html#napi_set_element)
...
##### napi\_get\_element[#](http://nodejs.cn/api-v12/n-api.html#napi_get_element)
...
##### napi\_has\_element[#](http://nodejs.cn/api-v12/n-api.html#napi_has_element)
...
##### napi\_delete\_element[#](http://nodejs.cn/api-v12/n-api.html#napi_delete_element)
...
##### napi\_define\_properties[#](http://nodejs.cn/api-v12/n-api.html#napi_define_properties)
...
This method allows the efficient definition of multiple properties on a given object. The properties are defined using property descriptors (see [`napi_property_descriptor`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_property_descriptor)). Given an array of such property descriptors, this API will set the properties on the object one at a time, as defined by `DefineOwnProperty()` (described in [Section 9.1.6](http://url.nodejs.cn/ac3ff8) of the ECMA-262 specification).

##### napi\_object\_freeze[#](http://nodejs.cn/api-v12/n-api.html#napi_object_freeze)

新增于: v12.20.0 N-API version: 8
...
##### napi\_object\_seal[#](http://nodejs.cn/api-v12/n-api.html#napi_object_seal)
...
This method seals a given object. This prevents new properties from being added to it, as well as marking all existing properties as non-configurable. This is described in [Section 19.1.2.20](https://tc39.es/ecma262/#sec-object.seal) of the ECMA-262 specification.

### 处理 JavaScript 函数[#](http://nodejs.cn/api-v12/n-api.html#working-with-javascript-functions)
...
Any non-`NULL` data which is passed to this API via the `data` field of the `napi_property_descriptor` items can be associated with `object` and freed whenever `object` is garbage-collected by passing both `object` and the data to [`napi_add_finalizer`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_add_finalizer).

#### napi\_call\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_call_function)
...
#### napi\_create\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_create_function)
...
-   `[in] cb`: The native function which should be called when this function object is invoked. [`napi_callback`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_callback) provides more details.
...
#### napi\_get\_new\_target[#](http://nodejs.cn/api-v12/n-api.html#napi_get_new_target)

新增于: v8.6.0 N-API version: 1
...
#### napi\_new\_instance[#](http://nodejs.cn/api-v12/n-api.html#napi_new_instance)
...
### 对象封装[#](http://nodejs.cn/api-v12/n-api.html#object-wrap)
...
1.  The [`napi_define_class`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_define_class) API defines a JavaScript class with constructor, static properties and methods, and instance properties and methods that correspond to the C++ class.
2.  When JavaScript code invokes the constructor, the constructor callback uses [`napi_wrap`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_wrap) to wrap a new C++ instance in a JavaScript object, then returns the wrapper object.
3.  When JavaScript code invokes a method or property accessor on the class, the corresponding `napi_callback` C++ function is invoked. For an instance callback, [`napi_unwrap`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_unwrap) obtains the C++ instance that is the target of the call.
...
#### napi\_define\_class[#](http://nodejs.cn/api-v12/n-api.html#napi_define_class)
...
-   `[in] length`: The length of the `utf8name` in bytes, or `NAPI_AUTO_LENGTH` if it is null-terminated.
-   `[in] constructor`: Callback function that handles constructing instances of the class. This should be a static method on the class, not an actual C++ constructor function. [`napi_callback`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_callback) provides more details.
...
The JavaScript constructor function returned from [`napi_define_class`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_define_class) is often saved and used later, to construct new instances of the class from native code, and/or check whether provided values are instances of the class. In that case, to prevent the function value from being garbage-collected, create a persistent reference to it using [`napi_create_reference`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_create_reference) and ensure the reference count is kept >= 1.
...
#### napi\_wrap[#](http://nodejs.cn/api-v12/n-api.html#napi_wrap)
...
-   `[in] finalize_cb`: Optional native callback that can be used to free the native instance when the JavaScript object is ready for garbage-collection. [`napi_finalize`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_finalize) provides more details.
...
_Caution_: The optional returned reference (if obtained) should be deleted via [`napi_delete_reference`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_delete_reference) ONLY in response to the finalize callback invocation. If it is deleted before then, then the finalize callback may never be invoked. Therefore, when obtaining a reference a finalize callback is also required in order to enable correct disposal of the reference.
...
#### napi\_unwrap[#](http://nodejs.cn/api-v12/n-api.html#napi_unwrap)
...
#### napi\_remove\_wrap[#](http://nodejs.cn/api-v12/n-api.html#napi_remove_wrap)

新增于: v8.5.0 N-API version: 1
...
#### napi\_type\_tag\_object[#](http://nodejs.cn/api-v12/n-api.html#napi_type_tag_object)
...
#### napi\_check\_object\_type\_tag[#](http://nodejs.cn/api-v12/n-api.html#napi_check_object_type_tag)
...
#### napi\_add\_finalizer[#](http://nodejs.cn/api-v12/n-api.html#napi_add_finalizer)

新增于: v8.0.0 N-API version: 5
...
-   `[in] finalize_cb`: Native callback that will be used to free the native data when the JavaScript object is ready for garbage-collection. [`napi_finalize`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_finalize) provides more details.
-   `[in] finalize_hint`: Optional contextual hint that is passed to the finalize callback.
...
### 简单的异步操作[#](http://nodejs.cn/api-v12/n-api.html#simple-asynchronous-operations)
...
N-API defines the `napi_async_work` structure which is used to manage asynchronous workers. Instances are created/deleted with [`napi_create_async_work`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_create_async_work) and [`napi_delete_async_work`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_delete_async_work).
...
Once created the async worker can be queued for execution using the [`napi_queue_async_work`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_queue_async_work) function:
...
[`napi_cancel_async_work`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_cancel_async_work) can be used if the work needs to be cancelled before the work has started execution.

After calling [`napi_cancel_async_work`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_cancel_async_work), the `complete` callback will be invoked with a status value of `napi_cancelled`. The work should not be deleted before the `complete` callback invocation, even when it was cancelled.

#### napi\_create\_async\_work[#](http://nodejs.cn/api-v12/n-api.html#napi_create_async_work)
...
-   `[in] env`: The environment that the API is invoked under.
-   `[in] async_resource`: An optional object associated with the async work that will be passed to possible `async_hooks` [`init` hooks](http://nodejs.cn/api-v12/async_hooks.html#async_hooks_init_asyncid_type_triggerasyncid_resource).
...
-   `[in] complete`: The native function which will be called when the asynchronous logic is completed or is cancelled. The given function is called from the main event loop thread. [`napi_async_complete_callback`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_async_complete_callback) provides more details.
...
This API allocates a work object that is used to execute logic asynchronously. It should be freed using [`napi_delete_async_work`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_delete_async_work) once the work is no longer required.

`async_resource_name` should be a null-terminated, UTF-8-encoded string.

The `async_resource_name` identifier is provided by the user and should be representative of the type of async work being performed. It is also recommended to apply namespacing to the identifier, e.g. by including the module name. See the [`async_hooks` documentation](http://nodejs.cn/api-v12/async_hooks.html#async_hooks_type) for more information.

#### napi\_delete\_async\_work[#](http://nodejs.cn/api-v12/n-api.html#napi_delete_async_work)
...
#### napi\_queue\_async\_work[#](http://nodejs.cn/api-v12/n-api.html#napi_queue_async_work)
...
#### napi\_cancel\_async\_work[#](http://nodejs.cn/api-v12/n-api.html#napi_cancel_async_work)
...
### 自定义的异步操作[#](http://nodejs.cn/api-v12/n-api.html#custom-asynchronous-operations)
...
#### napi\_async\_init[#](http://nodejs.cn/api-v12/n-api.html#napi_async_init)
...
-   `[in] env`: The environment that the API is invoked under.
-   `[in] async_resource`: Object associated with the async work that will be passed to possible `async_hooks` [`init` hooks](http://nodejs.cn/api-v12/async_hooks.html#async_hooks_init_asyncid_type_triggerasyncid_resource). In order to retain ABI compatibility with previous versions, passing `NULL` for `async_resource` will not result in an error, however, this will result incorrect operation of async hooks for the napi\_async\_context created. Potential issues include loss of async context when using the AsyncLocalStorage API.
-   `[in] async_resource_name`: Identifier for the kind of resource that is being provided for diagnostic information exposed by the `async_hooks` API.
-   `[out] result`: The initialized async context.

Returns `napi_ok` if the API succeeded.

#### napi\_async\_destroy[#](http://nodejs.cn/api-v12/n-api.html#napi_async_destroy)
...
#### napi\_make\_callback[#](http://nodejs.cn/api-v12/n-api.html#napi_make_callback)
...
#### napi\_open\_callback\_scope[#](http://nodejs.cn/api-v12/n-api.html#napi_open_callback_scope)

新增于: v9.6.0 N-API version: 3
...
-   `[in] env`: The environment that the API is invoked under.
-   `[in] resource_object`: An object associated with the async work that will be passed to possible `async_hooks` [`init` hooks](http://nodejs.cn/api-v12/async_hooks.html#async_hooks_init_asyncid_type_triggerasyncid_resource).
-   `[in] context`: Context for the async operation that is invoking the callback. This should be a value previously obtained from [`napi_async_init`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_async_init).
-   `[out] result`: The newly created scope.

There are cases (for example, resolving promises) where it is necessary to have the equivalent of the scope associated with a callback in place when making certain N-API calls. If there is no other script on the stack the [`napi_open_callback_scope`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_open_callback_scope) and [`napi_close_callback_scope`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_close_callback_scope) functions can be used to open/close the required scope.

#### napi\_close\_callback\_scope[#](http://nodejs.cn/api-v12/n-api.html#napi_close_callback_scope)
...
### 版本管理[#](http://nodejs.cn/api-v12/n-api.html#version-management)

#### napi\_get\_node\_version[#](http://nodejs.cn/api-v12/n-api.html#napi_get_node_version)
...
This function fills the `version` struct with the major, minor, and patch version of Node.js that is currently running, and the `release` field with the value of [`process.release.name`](http://nodejs.cn/api-v12/process.html#process_process_release).

The returned buffer is statically allocated and does not need to be freed.

#### napi\_get\_version[#](http://nodejs.cn/api-v12/n-api.html#napi_get_version)
...
### 内存管理[#](http://nodejs.cn/api-v12/n-api.html#memory-management)

#### napi\_adjust\_external\_memory[#](http://nodejs.cn/api-v12/n-api.html#napi_adjust_external_memory)
...
#### napi\_create\_promise[#](http://nodejs.cn/api-v12/n-api.html#napi_create_promise)
...
#### napi\_resolve\_deferred[#](http://nodejs.cn/api-v12/n-api.html#napi_resolve_deferred)
...
#### napi\_reject\_deferred[#](http://nodejs.cn/api-v12/n-api.html#napi_reject_deferred)
...
#### napi\_is\_promise[#](http://nodejs.cn/api-v12/n-api.html#napi_is_promise)
...
### 执行脚本[#](http://nodejs.cn/api-v12/n-api.html#script-execution)

N-API provides an API for executing a string containing JavaScript using the underlying JavaScript engine.

#### napi\_run\_script[#](http://nodejs.cn/api-v12/n-api.html#napi_run_script)
...
-   Unlike `eval`, this function does not allow the script to access the current lexical scope, and therefore also does not allow to access the [module scope](http://nodejs.cn/api-v12/modules.html#modules_the_module_scope), meaning that pseudo-globals such as `require` will not be available.
-   The script can access the [global scope](http://nodejs.cn/api-v12/globals.html). Function and `var` declarations in the script will be added to the [`global`](http://nodejs.cn/api-v12/globals.html#globals_global) object. Variable declarations made using `let` and `const` will be visible globally, but will not be added to the [`global`](http://nodejs.cn/api-v12/globals.html#globals_global) object.
-   The value of `this` is [`global`](http://nodejs.cn/api-v12/globals.html#globals_global) within the script.

### libuv 事件循环[#](http://nodejs.cn/api-v12/n-api.html#libuv-event-loop)

N-API provides a function for getting the current event loop associated with a specific `napi_env`.

#### napi\_get\_uv\_event\_loop[#](http://nodejs.cn/api-v12/n-api.html#napi_get_uv_event_loop)

新增于: v8.10.0, v9.3.0 N-API version: 2
...
### 异步线程-安全的函数调用[#](http://nodejs.cn/api-v12/n-api.html#asynchronous-thread-safe-function-calls)
...
#### 调用线程安全的函数[#](http://nodejs.cn/api-v12/n-api.html#calling-a-thread-safe-function)
...
#### 线程安全的函数的引用计数[#](http://nodejs.cn/api-v12/n-api.html#reference-counting-of-thread-safe-functions)
...
#### 决定是否保持进程运行[#](http://nodejs.cn/api-v12/n-api.html#deciding-whether-to-keep-the-process-running)
...
#### napi\_create\_threadsafe\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_create_threadsafe_function)
...
-   `[in] call_js_cb`: Optional callback which calls the JavaScript function in response to a call on a different thread. This callback will be called on the main thread. If not given, the JavaScript function will be called with no parameters and with `undefined` as its `this` value. [`napi_threadsafe_function_call_js`](http://nodejs.cn/api-v12/n-api.html#n_api_napi_threadsafe_function_call_js) provides more details.
-   `[out] result`: The asynchronous thread-safe JavaScript function.

#### napi\_get\_threadsafe\_function\_context[#](http://nodejs.cn/api-v12/n-api.html#napi_get_threadsafe_function_context)
...
#### napi\_call\_threadsafe\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_call_threadsafe_function)
...
#### napi\_acquire\_threadsafe\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_acquire_threadsafe_function)
...
#### napi\_release\_threadsafe\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_release_threadsafe_function)
...
#### napi\_ref\_threadsafe\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_ref_threadsafe_function)
...
This API is used to indicate that the event loop running on the main thread should not exit until `func` has been destroyed. Similar to [`uv_ref`](http://url.nodejs.cn/vG27Vk) it is also idempotent.
...
#### napi\_unref\_threadsafe\_function[#](http://nodejs.cn/api-v12/n-api.html#napi_unref_threadsafe_function)
...
This API is used to indicate that the event loop running on the main thread may exit before `func` is destroyed. Similar to [`uv_unref`](http://url.nodejs.cn/P7FfvC) it is also idempotent.

This API may only be called from the main thread.

### 其他实用工具[#](http://nodejs.cn/api-v12/n-api.html#miscellaneous-utilities)

### node\_api\_get\_module\_file\_name[#](http://nodejs.cn/api-v12/n-api.html#node_api_get_module_file_name)

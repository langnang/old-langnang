...
### [Vue.filter( id, \[definition\] )](https://cn.vuejs.org/v2/api/#Vue-filter "Vue.filter( id, [definition] )")
...
### [render](https://cn.vuejs.org/v2/api/#render "render")
...
### [vm.$forceUpdate()](https://cn.vuejs.org/v2/api/#vm-forceUpdate "vm.$forceUpdate()")
...
-   **预期**：可放置在函数参数位置的 JavaScript 表达式 (在[支持的环境下](https://cn.vuejs.org/v2/guide/components-slots.html#%E8%A7%A3%E6%9E%84%E6%8F%92%E6%A7%BD-Props)可使用解构)。可选，即只需要在为插槽传入 prop 的时候使用。
...
-   **参考**：
    ...
    -   [组件 - 对低开销的静态组件使用 `v-once`](https://cn.vuejs.org/v2/guide/components-edge-cases.html#%E9%80%9A%E8%BF%87-v-once-%E5%88%9B%E5%BB%BA%E4%BD%8E%E5%BC%80%E9%94%80%E7%9A%84%E9%9D%99%E6%80%81%E7%BB%84%E4%BB%B6)

## [特殊 attribute](https://cn.vuejs.org/v2/api/#%E7%89%B9%E6%AE%8A-attribute "特殊 attribute")
...
### [ref](https://cn.vuejs.org/v2/api/#ref "ref")
...
### [is](https://cn.vuejs.org/v2/api/#is "is")

-   **预期**：`string | Object (组件的选项对象)`
    
    用于[动态组件](https://cn.vuejs.org/v2/guide/components.html#%E5%8A%A8%E6%80%81%E7%BB%84%E4%BB%B6)且基于 [DOM 内模板的限制](https://cn.vuejs.org/v2/guide/components.html#%E8%A7%A3%E6%9E%90-DOM-%E6%A8%A1%E6%9D%BF%E6%97%B6%E7%9A%84%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)来工作。
...
-   **See also**：
    ...
    -   [DOM 模板解析说明](https://cn.vuejs.org/v2/guide/components.html#%E8%A7%A3%E6%9E%90-DOM-%E6%A8%A1%E6%9D%BF%E6%97%B6%E7%9A%84%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)

### [slot 废弃](https://cn.vuejs.org/v2/api/#slot-%E5%BA%9F%E5%BC%83 "slot 废弃")

**推荐 2.6.0 新增的 [v-slot](https://cn.vuejs.org/v2/api/#v-slot)。**

-   **预期**：`string`
    
    用于标记往哪个具名插槽中插入子组件内容。
    
-   **参考**：[具名插槽](https://cn.vuejs.org/v2/guide/components-slots.html#%E5%85%B7%E5%90%8D%E6%8F%92%E6%A7%BD)
    

### [slot-scope 废弃](https://cn.vuejs.org/v2/api/#slot-scope-%E5%BA%9F%E5%BC%83 "slot-scope 废弃")
...
-   **用法**：
    ...
    用于将元素或组件表示为作用域插槽。attribute 的值应该是可以出现在函数签名的参数位置的合法的 JavaScript 表达式。这意味着在支持的环境中，你还可以在表达式中使用 ES2015 解构。它在 2.5.0+ 中替代了 [`scope`](https://cn.vuejs.org/v2/api/#scope-replaced)。
...
### [scope 移除](https://cn.vuejs.org/v2/api/#scope-%E7%A7%BB%E9%99%A4 "scope 移除")
...
## [内置的组件](https://cn.vuejs.org/v2/api/#%E5%86%85%E7%BD%AE%E7%9A%84%E7%BB%84%E4%BB%B6 "内置的组件")

### [component](https://cn.vuejs.org/v2/api/#component "component")
...
### [transition](https://cn.vuejs.org/v2/api/#transition "transition")
...
### [transition-group](https://cn.vuejs.org/v2/api/#transition-group "transition-group")
...
### [keep-alive](https://cn.vuejs.org/v2/api/#keep-alive "keep-alive")
...
-   **参考**：[动态组件 - keep-alive](https://cn.vuejs.org/v2/guide/components-dynamic-async.html#%E5%9C%A8%E5%8A%A8%E6%80%81%E7%BB%84%E4%BB%B6%E4%B8%8A%E4%BD%BF%E7%94%A8-keep-alive)
    

### [slot](https://cn.vuejs.org/v2/api/#slot "slot")
...
-   **参考**：[通过插槽分发内容](https://cn.vuejs.org/v2/guide/components.html#%E9%80%9A%E8%BF%87%E6%8F%92%E6%A7%BD%E5%88%86%E5%8F%91%E5%86%85%E5%AE%B9)
    

## [VNode 接口](https://cn.vuejs.org/v2/api/#VNode-%E6%8E%A5%E5%8F%A3 "VNode 接口")

-   请参考 [VNode class declaration](https://github.com/vuejs/vue/blob/dev/src/core/vdom/vnode.js)。

## [服务端渲染](https://cn.vuejs.org/v2/api/#%E6%9C%8D%E5%8A%A1%E7%AB%AF%E6%B8%B2%E6%9F%93 "服务端渲染")

...
13. [new.target 属性](https://es6.ruanyifeng.com/#docs/class#new.target%20%E5%B1%9E%E6%80%A7)
...
【活动】IT 廉价课程超市 ApeClass 新上线，不必注册，直接试听前端、Python、JAVA、云计算等众多课程，满意再开通永久会员（所有课程仅需 299.5 元）。

](http://www.apeclass.com/?did=12)

...
/**
 * Class mock
 * copy from https://gitee.com/shoyu/phpmock/blob/master/mock.php
 */
...
class Mock
{
     ...
     * @return int|string
     */
    public function number($rule, $value = '0123456789')
    {
...
//            $max = $max > strlen($value) ? strlen($value) - 1 : $max;
     ...
     * @return string
     */
    public function float($rule, $decimal = null)
    {
     ...
     * @param $value
     */
    public function object($rule, $value = null)
    {
     ...
     * @return mixed
     */
    public function arr($rule, $value = null)
    {
